function [sa, sigma] = abrahamson_atten(M, r_rup, T, is_soil, fault_type, HW, arb);

% by Jack Baker, 2/1/05
% Stanford University
% bakerjw@stanford.edu
%
% Compute the Abrahamson and Silva attenuation prediction (1997
% Seismological Research Letters, Vol 68, No 1, p94). 
%
% This script has been modified to include standard deviations for either
% arbitrary or average components of ground motion (See Baker and Cornell,
% 2005, "What spectral acceleration are you using," Earthquake Spectra,
% submitted).
%
...
if (length(find(period == T)) == 0)
    ...
    [sa_low, sigma_low] = abrahamson_atten(M, r_rup, T_low, is_soil, fault_type, HW, arb);
    [sa_hi, sigma_hi] = abrahamson_atten(M, r_rup, T_hi, is_soil, fault_type, HW, arb);
