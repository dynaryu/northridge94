function [PGAs0,Ss]=PGAcalc(Rrup,R,M,F,HW)

[c4,a1,a2,a3,a4,a5,a6,a9,a10,a11,a12,a13,c1,c5,n1,b5,b6]=interpolation1(0);
...
if M<=5.80
    f3=a5;
elseif (M>5.8)&&(M<c1)
    f3=a5+(a6-a5)/(c1-5.8); %(a6-a5)*(M-5.8)/(c1-5.8)
elseif M>=c1
    f3=a6;
end
...
% PGA value calculation
PGAs0=exp(f1+F*f3+HW*f4);
